...
export function EditItem({ onOpen }: { onOpen: () => void }) {
  ...
  return (
    <button onClick={handleClick} className='controls-btn edit-btn'>
      <svg
        className='controls-btn__svg edit-btn__svg'
        width='19'
        height='19'
        viewBox='0 0 19 19'
        fill='none'
      ...
      <p className='controls-btn__text edit-btn__text'> Edit</p>
    </button>
  );
}
